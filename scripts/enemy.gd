...
func _ready():
	...
	#print("Patrol size: ", patrol_points.size())
	#if patrol_points.size() > 0:
		#print("Set The Target Position: ", patrol_points[current_target_index])
		#set_movement_target(patrol_points[current_target_index])
		#print("Set The Target Position: ",patrol_points[current_target_index])
...
func set_movement_target(movement_target: Vector3):
	#print("Target Position: ", movement_target)
	#print("Current Position: ", global_transform.origin)
	navigation_agent.set_target_position(movement_target)
	#look_towards(movement_target - global_transform.origin)
...
func look_towards(dir:Vector3):
	...
	var raycast_node = $RayCast3D_Scanner
	tween.tween_property(
		raycast_node, 
		"quaternion", 
		q, 
